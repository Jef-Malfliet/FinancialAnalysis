...
public class HistoryReportService extends ReportService {
    ...
    public HistoryReportService(
            ...
            List<DocumentWrapper> documents, ReportType style, XSSFDataFormat numberFormatter) {
    ...
    protected void createInternal() {
        ...
        String title = documents.get(0).getBusiness().getName() +
                (reportType.equals(ReportType.HISTORIEKNV) ? " NV" : " BVBA");
        ...
        if (reportType.equals(ReportType.HISTORIEKNV)) {
            addHistoryReportRow(
                    "EBIT MARGE", BoldTop,
                    "EBIT", BoldBottomTop,
        ...
        addHistoryReportRow(
                ...
                null, null,
                "OMZET", reportType.equals(ReportType.HISTORIEKNV) ? Bold : Grey);
        ...
        addHistoryReportRow(
                ...
                "", null,
                "CAPITAL EMPLOYED", reportType.equals(ReportType.HISTORIEKNV) ? Bold : Grey);
        ...
        addHistoryReportRow(
                ...
                "DSO", reportType.equals(ReportType.HISTORIEKNV) ? Bold : Grey,
                "OMZET", reportType.equals(ReportType.HISTORIEKNV) ? Bold : Grey);
        ...
        addHistoryReportRow(
                ...
                "DPO", reportType.equals(ReportType.HISTORIEKNV) ? Bold : Grey,
                "OMZET", reportType.equals(ReportType.HISTORIEKNV) ? Bold : Grey);
        ...
        addHistoryReportRow(
                ...
                reportType.equals(ReportType.HISTORIEKBVBA) ? i -> "/" : this::getBedrijfsOpbrengsten, BoldYellowNumber);
        ...
        if (reportType.equals(ReportType.HISTORIEKBVBA)) {
            addHistoryReportRow(
                    "AANKOPEN", Grey,
                    i -> "/", Grey,
    ...
    private void addHistoryRowDocumentValueCell(XSSFRow row, Function<Integer, String> formulaFunction1, XSSFCellStyle cellStyle) {
        if (formulaFunction1 != null || cellStyle != null) {
            for (int i = 0; i < documentCount; i++) {
                addReferenceCell(row, formulaFunction1 == null ? "/" : formulaFunction1.apply(i), (columnNumber) -> cellStyle);
            }
    ...
    private String getFreeCashFlowMargeOverOmzet(int i) {
        return getFreeCashFlow(i).inParenthesis().dividedBy(getBedrijfsOpbrengsten(i));
    }
